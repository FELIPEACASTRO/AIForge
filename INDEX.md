...
Auto-generated sitemap of every directory in the repository. For a topic-oriented entry point, see [NAVIGATION_GUIDE.md](./NAVIGATION_GUIDE.md).
...
## [01_AI_FUNDAMENTALS_AND_THEORY](./01_AI_FUNDAMENTALS_AND_THEORY/)
  ...
  - [`Courses/`](./01_AI_FUNDAMENTALS_AND_THEORY/Courses/)
    - [`Interpretability/`](./01_AI_FUNDAMENTALS_AND_THEORY/Courses/Interpretability/)
  - [`Deep_Learning/`](./01_AI_FUNDAMENTALS_AND_THEORY/Deep_Learning/)
    - [`3d_vision/`](./01_AI_FUNDAMENTALS_AND_THEORY/Deep_Learning/3d_vision/)
      - [`point_cloud_processing/`](./01_AI_FUNDAMENTALS_AND_THEORY/Deep_Learning/3d_vision/point_cloud_processing/)
    - [`Graph Models/`](./01_AI_FUNDAMENTALS_AND_THEORY/Deep_Learning/Graph Models/)
    - [`Loss_Functions/`](./01_AI_FUNDAMENTALS_AND_THEORY/Deep_Learning/Loss_Functions/)
    - [`Neural Architecture Search/`](./01_AI_FUNDAMENTALS_AND_THEORY/Deep_Learning/Neural Architecture Search/)
    ...
    - [`graph_neural_networks/`](./01_AI_FUNDAMENTALS_AND_THEORY/Deep_Learning/graph_neural_networks/)
  ...
  - [`Domain_Adaptation/`](./01_AI_FUNDAMENTALS_AND_THEORY/Domain_Adaptation/)
    - [`Transfer Learning/`](./01_AI_FUNDAMENTALS_AND_THEORY/Domain_Adaptation/Transfer Learning/)
  ...
  - [`Generative_Models/`](./01_AI_FUNDAMENTALS_AND_THEORY/Generative_Models/)
    ...
    - [`Variational Autoencoders/`](./01_AI_FUNDAMENTALS_AND_THEORY/Generative_Models/Variational Autoencoders/)
  ...
  - [`LLM_Architectures/`](./01_AI_FUNDAMENTALS_AND_THEORY/LLM_Architectures/)
    - [`Eficiencia_Contexto_Longo/`](./01_AI_FUNDAMENTALS_AND_THEORY/LLM_Architectures/Eficiencia_Contexto_Longo/)
  ...
  - [`Machine_Learning/`](./01_AI_FUNDAMENTALS_AND_THEORY/Machine_Learning/)
    ...
    - [`federated_learning/`](./01_AI_FUNDAMENTALS_AND_THEORY/Machine_Learning/federated_learning/)
    - [`platform/`](./01_AI_FUNDAMENTALS_AND_THEORY/Machine_Learning/platform/)
    - [`training_strategies/`](./01_AI_FUNDAMENTALS_AND_THEORY/Machine_Learning/training_strategies/)
    - [`transfer_learning/`](./01_AI_FUNDAMENTALS_AND_THEORY/Machine_Learning/transfer_learning/)
    - [`zero_shot_learning/`](./01_AI_FUNDAMENTALS_AND_THEORY/Machine_Learning/zero_shot_learning/)
  - [`Meta_Learning/`](./01_AI_FUNDAMENTALS_AND_THEORY/Meta_Learning/)
  - [`Model_Optimization/`](./01_AI_FUNDAMENTALS_AND_THEORY/Model_Optimization/)
  - [`Modern_Fine_Tuning/`](./01_AI_FUNDAMENTALS_AND_THEORY/Modern_Fine_Tuning/)
  - [`Multimodal/`](./01_AI_FUNDAMENTALS_AND_THEORY/Multimodal/)
    - [`vision-language/`](./01_AI_FUNDAMENTALS_AND_THEORY/Multimodal/vision-language/)
  ...
  - [`Prompt_Engineering/`](./01_AI_FUNDAMENTALS_AND_THEORY/Prompt_Engineering/)
    ...
    - [`Educational_Prompts/`](./01_AI_FUNDAMENTALS_AND_THEORY/Prompt_Engineering/Educational_Prompts/)
...
## [02_LLM_AND_AI_MODELS](./02_LLM_AND_AI_MODELS/)
  ...
  - [`Audio_Models/`](./02_LLM_AND_AI_MODELS/Audio_Models/)
    - [`speech-to-text/`](./02_LLM_AND_AI_MODELS/Audio_Models/speech-to-text/)
  - [`Collections/`](./02_LLM_AND_AI_MODELS/Collections/)
  - [`Communities/`](./02_LLM_AND_AI_MODELS/Communities/)
  ...
  - [`Text_LLMs/`](./02_LLM_AND_AI_MODELS/Text_LLMs/)
    ...
    - [`Libraries/`](./02_LLM_AND_AI_MODELS/Text_LLMs/Libraries/)
    - [`Open_Source_LLMs/`](./02_LLM_AND_AI_MODELS/Text_LLMs/Open_Source_LLMs/)
      - [`openai/`](./02_LLM_AND_AI_MODELS/Text_LLMs/Open_Source_LLMs/openai/)
  ...
  - [`Vision_Models/`](./02_LLM_AND_AI_MODELS/Vision_Models/)
    - [`Image_Generation/`](./02_LLM_AND_AI_MODELS/Vision_Models/Image_Generation/)
...
## [03_DATASETS_TOOLS_AND_RESOURCES](./03_DATASETS_TOOLS_AND_RESOURCES/)
  ...
  - [`Data_Engineering/`](./03_DATASETS_TOOLS_AND_RESOURCES/Data_Engineering/)
    ...
    - [`Data_Science/`](./03_DATASETS_TOOLS_AND_RESOURCES/Data_Engineering/Data_Science/)
      - [`Feature Engineering/`](./03_DATASETS_TOOLS_AND_RESOURCES/Data_Engineering/Data_Science/Feature Engineering/)
    ...
    - [`Feature_Engineering/`](./03_DATASETS_TOOLS_AND_RESOURCES/Data_Engineering/Feature_Engineering/)
      ...
      - [`Features_Histológicas/`](./03_DATASETS_TOOLS_AND_RESOURCES/Data_Engineering/Feature_Engineering/Features_Histológicas/)
  ...
  - [`Datasets/`](./03_DATASETS_TOOLS_AND_RESOURCES/Datasets/)
    ...
    - [`Biomass_Datasets, Agriculture_Datasets, Spatial_Feature_Engineering/`](./03_DATASETS_TOOLS_AND_RESOURCES/Datasets/Biomass_Datasets, Agriculture_Datasets, Spatial_Feature_Engineering/)
    ...
    - [`Machine Learning/`](./03_DATASETS_TOOLS_AND_RESOURCES/Datasets/Machine Learning/)
...
## [04_MLOPS_AND_PRODUCTION_AI](./04_MLOPS_AND_PRODUCTION_AI/)
  ...
  - [`AI_Observability/`](./04_MLOPS_AND_PRODUCTION_AI/AI_Observability/)
    - [` llm-ops/`](./04_MLOPS_AND_PRODUCTION_AI/AI_Observability/ llm-ops/)
  ...
  - [`Infrastructure/`](./04_MLOPS_AND_PRODUCTION_AI/Infrastructure/)
  ...
  - [`MLOps_Platforms/`](./04_MLOPS_AND_PRODUCTION_AI/MLOps_Platforms/)
    ...
    - [`Plataformas/`](./04_MLOPS_AND_PRODUCTION_AI/MLOps_Platforms/Plataformas/)
...
## [05_VERTICAL_APPLICATIONS](./05_VERTICAL_APPLICATIONS/)
  ...
  - [`01_Healthcare_and_Medical_AI/`](./05_VERTICAL_APPLICATIONS/01_Healthcare_and_Medical_AI/)
    ...
    - [`Clinical_Decision_Support e Biomedical_NLP/`](./05_VERTICAL_APPLICATIONS/01_Healthcare_and_Medical_AI/Clinical_Decision_Support e Biomedical_NLP/)
    ...
    - [`Genomics/`](./05_VERTICAL_APPLICATIONS/01_Healthcare_and_Medical_AI/Genomics/)
      - [`variant-calling, genomics/`](./05_VERTICAL_APPLICATIONS/01_Healthcare_and_Medical_AI/Genomics/variant-calling, genomics/)
        - [`protein-folding/`](./05_VERTICAL_APPLICATIONS/01_Healthcare_and_Medical_AI/Genomics/variant-calling, genomics/protein-folding/)
    - [`Medical Imaging/`](./05_VERTICAL_APPLICATIONS/01_Healthcare_and_Medical_AI/Medical Imaging/)
    ...
    - [`Paper_Científico/`](./05_VERTICAL_APPLICATIONS/01_Healthcare_and_Medical_AI/Paper_Científico/)
    ...
    - [`Public_Health/`](./05_VERTICAL_APPLICATIONS/01_Healthcare_and_Medical_AI/Public_Health/)
      - [`Vigilância Epidemiológica/`](./05_VERTICAL_APPLICATIONS/01_Healthcare_and_Medical_AI/Public_Health/Vigilância Epidemiológica/)
  ...
  - [`02_Finance_and_Fintech_AI/`](./05_VERTICAL_APPLICATIONS/02_Finance_and_Fintech_AI/)
    ...
    - [`Payment_e_Transaction/`](./05_VERTICAL_APPLICATIONS/02_Finance_and_Fintech_AI/Payment_e_Transaction/)
  ...
  - [`03_Agriculture_AgTech/`](./05_VERTICAL_APPLICATIONS/03_Agriculture_AgTech/)
    ...
    - [`Biomass_Estimation, Benchmark_Dataset, Deep_Learning_Implementation/`](./05_VERTICAL_APPLICATIONS/03_Agriculture_AgTech/Biomass_Estimation, Benchmark_Dataset, Deep_Learning_Implementation/)
    ...
    - [`Crop_Disease_Detection, Biomass_Estimation/`](./05_VERTICAL_APPLICATIONS/03_Agriculture_AgTech/Crop_Disease_Detection, Biomass_Estimation/)
      - [`Vegetation_Structure, Crop_Type_Prediction/`](./05_VERTICAL_APPLICATIONS/03_Agriculture_AgTech/Crop_Disease_Detection, Biomass_Estimation/Vegetation_Structure, Crop_Type_Prediction/)
        - [`Remote_Sensing/`](./05_VERTICAL_APPLICATIONS/03_Agriculture_AgTech/Crop_Disease_Detection, Biomass_Estimation/Vegetation_Structure, Crop_Type_Prediction/Remote_Sensing/)
    ...
    - [`Crop_Yield_Prediction, Pest_and_Disease_Detection, Agricultural_AGI_Framework, Biomass_Estimation/`](./05_VERTICAL_APPLICATIONS/03_Agriculture_AgTech/Crop_Yield_Prediction, Pest_and_Disease_Detection, Agricultural_AGI_Framework, Biomass_Estimation/)
    - [`Earth_Observation_Foundation_Model/`](./05_VERTICAL_APPLICATIONS/03_Agriculture_AgTech/Earth_Observation_Foundation_Model/)
    - [`Few_Shot_Learning_Doenças_Raras/`](./05_VERTICAL_APPLICATIONS/03_Agriculture_AgTech/Few_Shot_Learning_Doenças_Raras/)
    ...
    - [`TinyML_Edge_Deployment e Plant_Disease_Detection_Edge_AI/`](./05_VERTICAL_APPLICATIONS/03_Agriculture_AgTech/TinyML_Edge_Deployment e Plant_Disease_Detection_Edge_AI/)
  ...
  - [`16_Edge_and_IoT_AI/`](./05_VERTICAL_APPLICATIONS/16_Edge_and_IoT_AI/)
    - [`Mobile ML/`](./05_VERTICAL_APPLICATIONS/16_Edge_and_IoT_AI/Mobile ML/)
  - [`17_Conversational_AI/`](./05_VERTICAL_APPLICATIONS/17_Conversational_AI/)
    - [`Dialogue Systems/`](./05_VERTICAL_APPLICATIONS/17_Conversational_AI/Dialogue Systems/)
  - [`18_Predictive_AI/`](./05_VERTICAL_APPLICATIONS/18_Predictive_AI/)
    ...
    - [`Template_Kit_de_Estratégia/`](./05_VERTICAL_APPLICATIONS/18_Predictive_AI/Template_Kit_de_Estratégia/)
