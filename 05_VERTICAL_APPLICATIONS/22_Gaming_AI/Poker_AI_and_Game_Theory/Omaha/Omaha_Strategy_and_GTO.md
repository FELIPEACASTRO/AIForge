...
> | **Gambling Therapy (Gordon Moody)** | International | Free multilingual online support, **including Portuguese (Brazil)** — [gamblingtherapy.org/pt-br](https://www.gamblingtherapy.org/pt-br/) |
>
...
## Why Omaha Strategy ≠ Hold'em Strategy
...
**Consequence:** the winning skills are *nut-focus*, *redraws*, *blockers* and *equity realization* under a betting cap — not the "make top pair and bet" logic of Hold'em.

---

## Preflop — Hand Selection & Positional Ranges

### The four dimensions of a starting hand
...
| **Nuttiness** — *most important postflop lever* | Ability to make **nut** straights/flushes/top set | "Making strong hands is relatively easy in PLO, so it is preferable to play hands that can make the nuts relatively easily" — avoid weak straights/flushes like 3♠4♦5♠6♦ |
| **Connectedness** | All four cards work together for straights/wraps | 7♥8♥9♠T♠ ≫ 9♣8♦5♦Q♦, where the Q and 5 are disconnected |
| **Suitedness** | Double-suited > single-suited > rainbow | "Double-suited hands are preferable"; **avoid triple-suited** hands — a third card of a suit "block[s] your own flush-draw outs" |

**Danglers:** a fourth card that doesn't connect or suit (the 9 in K♣Q♦J♠9♥ that leaves a gap, or an offsuit low card next to three Broadway cards) drops you effectively to a three-card hand. The best hands score on all four dimensions at once — e.g. **double-suited premium rundowns** like A♠K♠Q♥J♥ or K♦Q♦J♣T♣.
...
| Position | Open-raise range character |
|---|---|
...
## 3-Bet / 4-Bet Pot-Limit Dynamics
...
## Postflop — The Nut-and-Redraw Principle

> **PLO is a game of the nuts and the redraw to the nuts.**
...
|---|---|---|
| **Coordinated / wet** | 8♠9♣T♦ | "Top pair or even two pair is rarely strong enough to commit significant chips." Bet/raise your **big wraps, flush-draw-plus-pair combos, and made straights with redraws**; fold marginal made hands |
| **Dry / dispersed** | K♦7♠2♣ rainbow | Top set and strong overpairs with backup hold more value; **bluffing is more realistic** because opponents connect less often |
...
- **Common sizes** are fractions of the pot: roughly ~1/2 pot, ~2/3–3/4 pot, and the **pot-sized bet** as the maximum. There is no over-bet available.
...
## Omaha Hi-Lo (Omaha-8) — Split-Pot Strategy

Hi-Lo layers a second, ace-to-five **low** onto the high game (rules, the 8-or-better qualifier, the wheel = nut low, and quartering are covered on the [Rules page](./Omaha_Variants_and_Rules.md)). Strategy is dominated by one word: **scoop**.
...
- **Quartering math.** "Quartering occurs when you tie with another player for half the pot (usually the low), receiving only 25% of the total pot." As the source puts it, "if you contributed more than 25% of the pot through aggressive betting, you lose money despite 'winning' your share." Guard against it by holding **backup cards** (e.g. A-2-3 so a counterfeited deuce still leaves a nut low) or by focusing only on scoop-capable hands.
...
## Solver-Derived Concepts & Study Tools
