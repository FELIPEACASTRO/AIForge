...
> The complete, fact-checked index of **poker as an AI/ML research domain** — the landmark superhuman AIs (Libratus, Pluribus), CFR game theory, GTO foundations, solvers, datasets, strategy resources, and the analytics software stack. **7 pages, every paper/repo/tool verified to exist.**
