...
|---|---|---|---|
| **ABIDES** (Agent-Based Interactive Discrete Event Simulation) | ABM / discrete-event LOB | Nanosecond-resolution exchange with NASDAQ-style ITCH/OUCH messaging; tens of thousands of agents; high-fidelity LOB data generation & microstructure experiments | <https://github.com/abides-sim/abides> |
| **ABIDES-JPMC (public)** | ABM (maintained fork) | J.P. Morgan's maintained ABIDES with `abides-markets` + `abides-gym`; recommended current entry point | <https://github.com/jpmorganchase/abides-jpmc-public> |
...
| **ABIDES-MARL** (2025) | Multi-agent RL env | Endogenous price formation & execution in a LOB; multi-agent RL on top of ABIDES | <https://arxiv.org/abs/2511.02016> |
| **JAX-LOB** (Frey et al., ICAIF'23) | GPU-accelerated LOB sim | First GPU LOB simulator; simulates *thousands* of books in parallel via JAX → fast end-to-end RL for execution | paper <https://arxiv.org/abs/2308.13289> · code <https://github.com/KangOxford/jax-lob> |
| **mbt_gym** (Jerome et al., ICAIF'23) | Model-based LOB gym | Vectorised gym envs for market-making & optimal execution (Avellaneda-Stoikov-style models); plugs into Stable-Baselines3 | paper <https://dl.acm.org/doi/10.1145/3604237.3626873> · code <https://github.com/JJJerome/mbt_gym> |
| **Limit Order Book Simulations: A Review** (2024) | Survey | Taxonomy of point-process, ABM, and deep-learning LOB simulators — orientation map | <https://arxiv.org/abs/2402.17359> |

**Notes.** ABIDES is the de-facto research standard (originated at Georgia Tech / J.P. Morgan AI Research). For GPU-scale RL, JAX-LOB and mbt_gym are the current go-tos. The 2024 review (arXiv 2402.17359) is the best single map of the landscape.
...
| **Conditional Sig-Wasserstein GAN (SigCWGAN)** (Ni, Szpruch, et al. 2020) | GAN + path signature | Sig-W₁ metric as discriminator + AR-FNN generator; principled time-series GAN validated on financial data | paper <https://arxiv.org/abs/2006.05421> · code <https://github.com/SigCGANs/Conditional-Sig-Wasserstein-GANs> |
...
| **Deep Hedging: Learning to Simulate Equity Option Markets** (Wiese, Bai, Wood, Buehler 2019) | GAN (option surfaces) | GAN market generator for *equity option markets* → training data for deep hedging | <https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3470756> |
...
| **Stylized Facts Alignment GAN (SFAG)** / *Beyond Visual Realism* (2026) | GAN (constrained) | Converts stylized facts into differentiable constraints; backtest-aware generation | <https://arxiv.org/abs/2601.12990> |
...
| Tool / paper | Type | Use | Link |
|---|---|---|---|
| **TSDiff** — *Predict, Refine, Synthesize* (Amazon, NeurIPS'23) | Diffusion (general TS) | Unconditional diffusion + self-guidance for forecasting & synthetic TS generation | paper <https://neurips.cc/virtual/2023/poster/70377> · code <https://github.com/amazon-science/unconditional-time-series-diffusion> |
| **TRADES** — *Generating Realistic Market Simulations with Diffusion Models* (2025) | Diffusion (order-level LOB) | Order-by-order LOB generation; counterfactual analysis via agent interaction; ships **DeepMarket** framework | paper <https://arxiv.org/abs/2502.07071> · code <https://github.com/LeonardoBerti00/DeepMarket> |
| **LOBS5** (Nagy et al. 2025) | Deep state-space (S5) LOB | Autoregressive message-by-order LOB generator; strong LOB-Bench baseline | (see LOB-Bench) <https://arxiv.org/abs/2502.09172> |
| **Painting the Market** (2025) | Diffusion + inpainting | LOB → image format, diffusion inpainting for simulation *and* forecasting; SOTA on LOB-Bench | <https://arxiv.org/abs/2509.05107> |
| **DiffVolume** (2025) | Diffusion (LOB volumes) | Generates high-dimensional LOB volume snapshots across price levels | <https://arxiv.org/abs/2508.08698> |
| **DiffLOB** (2026) | Diffusion (counterfactuals) | Counterfactual generation in limit order books | <https://arxiv.org/abs/2602.03776> |
| **CoFinDiff** (2025) | Controllable diffusion | Conditioned financial TS generation (target stylized facts/regimes) | <https://arxiv.org/abs/2503.04164> |
| **Generation of synthetic financial TS by diffusion models** (2024) | Diffusion (returns) | Diffusion vs GAN/VAE on stylized facts for return series | <https://arxiv.org/abs/2410.18897> |
...
| **Neural SDEs for Conditional TS Generation + Sig-W₁** (2023) | Neural SDE + signature | Conditional generation with Signature-Wasserstein-1 metric | <https://arxiv.org/abs/2301.01315> |
| **Deep Generators on Commodity Markets** (2022) | VAE/GAN generators | Market generators applied to commodity markets → deep hedging | <https://arxiv.org/abs/2205.13942> |

**Signature-based generators** deserve a callout: path signatures give a model-free, theoretically-grounded feature map of a price path. See also *Generating drawdown-realistic financial price paths using path signatures* (<https://arxiv.org/abs/2309.04507>).
...
| Tool | Type | Use | Link |
|---|---|---|---|
| **FinRL-Meta** (AI4Finance, NeurIPS'22 track) | RL env universe | Hundreds of near-real market environments + data engineering layer; GPU multiprocessing; companion to FinRL | paper <https://arxiv.org/abs/2112.06753> · code <https://github.com/AI4Finance-Foundation/FinRL-Meta> |
...
**Pick guide.** Need a *reactive* market with market impact → ABIDES-Gym or mbt_gym. Need breadth of assets + data pipeline → FinRL-Meta. Need a quick toy env → Gym-Trading-Env / gym-anytrading.
...
| **TSGM** (Nikitin et al., NeurIPS'24) | TS generative framework | Generative + simulation-based + augmentation methods; multi-angle eval (similarity, downstream, privacy); Keras/TF/Torch/JAX | paper <https://arxiv.org/abs/2305.11567> · code <https://github.com/AlexanderVNikitin/tsgm> |
...
| **Can GANs Learn the Stylized Facts...?** (ICAIF'24) | Sobering empirical check of GAN fidelity on stylized facts | <https://dl.acm.org/doi/fullHtml/10.1145/3677052.3698661> |
| **Beyond Visual Realism** (2026) | Backtest-aware evaluation + SFAG constrained generator | <https://arxiv.org/abs/2601.12990> |
| **Limit Order Book Simulations: A Review** (2024) | Survey/taxonomy of LOB simulators | <https://arxiv.org/abs/2402.17359> |
| **GANs in time series: survey & taxonomy** (2021) | Map of TS-GAN architectures (incl. finance) | <https://arxiv.org/abs/2107.11098> |
| **Systematic comparison of deep generative models on multivariate financial TS** (2024) | Head-to-head GAN/VAE/diffusion comparison | <https://arxiv.org/abs/2412.06417> |
...
**Sources:** <https://github.com/abides-sim/abides> · <https://github.com/jpmorganchase/abides-jpmc-public> · <https://arxiv.org/abs/2110.14771> · <https://arxiv.org/abs/2511.02016> · <https://arxiv.org/abs/2308.13289> · <https://github.com/KangOxford/jax-lob> · <https://dl.acm.org/doi/10.1145/3604237.3626873> · <https://github.com/JJJerome/mbt_gym> · <https://arxiv.org/abs/2402.17359> · <https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3384948> · <https://www.risk.net/cutting-edge/7401191/the-market-generator> · <https://arxiv.org/abs/1907.06673> · <https://github.com/JamesSullivan/temporalCN> · <https://arxiv.org/abs/2006.05421> · <https://github.com/SigCGANs/Conditional-Sig-Wasserstein-GANs> · <https://arxiv.org/abs/2111.01207> · <https://www.tandfonline.com/doi/full/10.1080/14697688.2023.2299466> · <https://github.com/milenavuletic/Fin-GAN> · <https://papers.nips.cc/paper/8789-time-series-generative-adversarial-networks> · <https://github.com/jsyoon0823/TimeGAN> · <https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3470756> · <https://arxiv.org/abs/2307.02310> · <https://arxiv.org/abs/2601.12990> · <https://neurips.cc/virtual/2023/poster/70377> · <https://github.com/amazon-science/unconditional-time-series-diffusion> · <https://arxiv.org/abs/2502.07071> · <https://github.com/LeonardoBerti00/DeepMarket> · <https://arxiv.org/abs/2502.09172> · <https://lobbench.github.io/> · <https://github.com/peernagy/lob_bench> · <https://arxiv.org/abs/2509.05107> · <https://arxiv.org/abs/2508.08698> · <https://arxiv.org/abs/2602.03776> · <https://arxiv.org/abs/2503.04164> · <https://arxiv.org/abs/2410.18897> · <https://arxiv.org/abs/2007.04154> · <https://arxiv.org/abs/2301.01315> · <https://arxiv.org/abs/2205.13942> · <https://arxiv.org/abs/2309.04507> · <https://arxiv.org/abs/2112.06753> · <https://github.com/AI4Finance-Foundation/FinRL-Meta> · <https://github.com/ClementPerroud/Gym-Trading-Env> · <https://github.com/AminHP/gym-anytrading> · <https://github.com/Yvictor/TradingGym> · <https://github.com/hackthemarket/gym-trading> · <https://github.com/sdv-dev/SDV> · <https://github.com/sdv-dev/CTGAN> · <https://arxiv.org/abs/2301.07573> · <https://github.com/vanderschaarlab/synthcity> · <https://arxiv.org/abs/2305.11567> · <https://github.com/AlexanderVNikitin/tsgm> · <https://github.com/sunchang0124/dp_cgans> · <https://dl.acm.org/doi/fullHtml/10.1145/3677052.3698661> · <https://arxiv.org/abs/2107.11098> · <https://arxiv.org/abs/2412.06417>

**Keywords:** market simulation, synthetic market data, agent-based market simulation, limit order book, LOB, ABIDES, JAX-LOB, market generator, Quant GANs, Sig-Wasserstein GAN, signatures, TimeGAN, diffusion models, TRADES, LOB-Bench, neural SDE, deep hedging, reinforcement learning trading, FinRL-Meta, trading gym, CTGAN, SDV, synthcity, TSGM, stylized facts, backtest overfitting, market impact, stress testing — simulação de mercado, dados sintéticos de mercado, simulação baseada em agentes, livro de ofertas, gerador de mercado, redes adversárias generativas, modelos de difusão, hedge profundo, aprendizado por reforço, ambiente de negociação, dados tabulares sintéticos, fatos estilizados, sobreajuste de backtest, impacto de mercado, testes de estresse, B3, ações, escassez de dados
