...
- **Flagship index — Straits Times Index (STI):** the **top 30** SGX Mainboard companies by **free-float-adjusted market capitalisation**, calculated and managed by **FTSE Russell** under a joint venture (Singapore Press Holdings / SPH, SGX and FTSE). A liquidity screen requires the median daily traded volume to be at least ~0.08% of shares in issue for ≥8 of the 12 months before the March/September review. <https://www.sgx.com/indices/products/sti> · ground rules: <https://www.lseg.com/content/dam/ftse-russell/en_us/documents/ground-rules/straits-times-index-ground-rules.pdf>
...
- **Price limits (ceiling/floor):** daily moves capped at **±30%** of the prior close; on the **first trading day** ceiling/floor may not exceed **3× the IPO price**. SET has at times imposed temporary **±15%** bands and a dynamic price band during stress. <https://www.set.or.th/en/trading-units-tick-sizes-price-limits>
...
- **Settlement:** **T+2** via SCCP (migrated to T+2 from T+3). <https://www.pse.com.ph/sccp-marks-successful-migration-to-the-t2-settlement-cycle/>
...
- **Settlement:** **T+2** (Vietnam moved to T+2 from the older T+3-style cycle). Trading system upgraded around the **KRX (Korea Exchange) platform** rollout to lift capacity and enable features pre-requisite for an MSCI/FTSE EM upgrade.
...
- **Regional integration:** the **ASEAN Exchanges** collaboration links SGX, IDX, SET, Bursa, PSE, HOSE/HNX (and HNX) for harmonised disclosure and cross-promotion <https://www.aseanexchanges.org/>. The historical **ASEAN Trading Link** (SGX–Bursa–SET cross-border routing) has been wound down, but cross-listing and depositary-receipt programmes persist.
...
- **Index-event / reconstitution arbitrage:** semi-annual **SET50/SET100**, March/September **STI**, and FTSE/MSCI ASEAN reviews drive predictable add/delete flows — a classic event-driven ML target (predict additions from cap/free-float/liquidity screens).
...
- SET: <https://www.set.or.th/en/market/information/trading-procedure/trading-hours> · <https://www.set.or.th/en/trading-units-tick-sizes-price-limits> · <https://www.set.or.th/en/market/index/set50/profile>
...
- Vietnam: <https://en.wikipedia.org/wiki/Ho_Chi_Minh_City_Stock_Exchange> · <https://github.com/thinh-vu/vnstock> · <https://github.com/vnstock-official/vnstock>
