...
|---|---|---|
| SSE & SZSE Main Board A/B-shares | **±10%** | **No limit on first trading day** post-IPO |
...
| **baostock** | [github.com/topics/baostock](https://github.com/topics/baostock) | Historical A-share bars, adjusted prices, valuation | **No key** (free, `login()/logout()`) | Good for clean adjusted OHLCV |
...
- **STAR & ChiNext = ±20%**, main board **±10%**, **Beijing ±30%**; IPOs are **unlimited for 5 days** on STAR/ChiNext, 1 day on main/BSE.
