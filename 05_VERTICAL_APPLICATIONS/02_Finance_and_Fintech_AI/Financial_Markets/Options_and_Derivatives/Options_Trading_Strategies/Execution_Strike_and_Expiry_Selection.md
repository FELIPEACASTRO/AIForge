...
- **Weeklies are European-style:** B3 **weekly stock options (opções semanais sobre ações)** are **European-style** (exercise only at expiry), unlike the American-style monthly single-stock series — a key distinction when planning early-exercise/assignment risk ([B3 Educação — Opções Semanais](https://edu.b3.com.br/w/opcoes-semanais)).
- **Liquidity reality:** depth concentrates in a handful of names and near-month series; weeklies exist but are far thinner than US — favor the most-traded series and budget for wider spreads.
