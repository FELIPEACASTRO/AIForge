...
| [**soccerdata**](https://github.com/probberechts/soccerdata) / [**ScraperFC**](https://github.com/oseymour/ScraperFC) | ⚠️ source-dependent (referee is exposed by some Sofascore / WhoScored match feeds, not all) | ✅ match-level cards/fouls | **Free lib** | Scrape — **respect each site's ToS** and local law |
...
|---|---|---|
| England (PL) | [**Premier League — Referees hub**](https://www.premierleague.com/en/referees) | Officiating-body hub (**PGMOL rebranded as "Pro Ref" from 2026/27**); each round's match officials (referee, ARs, 4th, VAR) are published as Premier League "Match officials for Matchweek N" news items |
| England (EFL) | [**EFL — Match Officials**](https://www.efl.com/match-officials/) | Official EFL match-officials page (now under **Pro Ref**); Championship / League One / League Two |
