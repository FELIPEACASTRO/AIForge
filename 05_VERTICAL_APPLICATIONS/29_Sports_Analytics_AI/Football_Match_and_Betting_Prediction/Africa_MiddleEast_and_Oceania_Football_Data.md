...
> **A-League official data (Stats Perform / Opta):** in Oct 2024 the A-Leagues **extended** their official media-data deal with Stats Perform, adding *Opta Stream* and *Opta Search* ([Sports Video Group](https://www.sportsvideo.org/2024/10/18/a-leagues-extends-with-stats-perform-adds-opta-stream-and-opta-search-to-deepen-fan-engagement-and-grow-sponsor-inventory-for-mens-and-womens-competitions/) · [Inside World Football](https://www.insideworldfootball.com/2024/10/15/aussie-league-adds-opta-search-opta-stream-stats-perform-data-deal/)). Combined with the SkillCorner open set, the A-League is the one competition here where **advanced/tracking modelling** is genuinely feasible.
...
| **Stats Perform / Opta** | Official partner of A-League + SPL ecosystem | ➖ | Enterprise | [statsperform.com/opta](https://www.statsperform.com/opta/) |
