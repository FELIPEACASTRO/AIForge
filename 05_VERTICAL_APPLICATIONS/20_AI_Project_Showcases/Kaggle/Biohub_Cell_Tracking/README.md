...
| [Devastating Double Check - 2026-07-09](./Devastating_Double_Check_2026-07-09.md) | Four-agent double check of Kaggle, HF, weights, model routes, notebook-pulled calibration constants, caveats, and next search prompts. |
| [Deep Source Atlas - 2026-07-09](./Deep_Source_Atlas_2026-07-09.md) | Expanded source atlas across official Kaggle/Biohub evidence, live notebook signals, methods, models, datasets, evaluation tooling, and risk-monitoring leads. |
| [Kaggle Notebook and Discussion Radar - 2026-07-09](./Kaggle_Notebook_Discussion_Radar_2026-07-09.md) | Live Kaggle CLI radar for leaderboard frontier, notebooks by votes/date/score, output artifacts, discussion topics, and automation next steps. |
| [ML and AI Model, Feature, Weight, and Calibration Atlas - 2026-07-09](./ML_AI_Model_Feature_Calibration_Atlas_2026-07-09.md) | Technical inventory of models, weights, algorithms, feature families, calibration knobs, datasets, public notebook signals, and experiment queues. |
| [Reproducibility and Model Roadmap - 2026-07-09](./Reproducibility_Model_Roadmap_2026-07-09.md) | Practical roadmap for official baseline locking, segmentation sweeps, linking/gap recovery, division handling, pretraining data, and artifact discipline. |
